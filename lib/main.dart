...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Socket audio demo'),
    );
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            IconButton(iconSize: 100,onPressed:()=> sendMessage("default","Bell"),
            icon: Image.asset(
              "assets/image/dell.jpg",
            ),),
            IconButton(iconSize: 100,onPressed:()=> sendMessage("default","Clave"),
              icon: Image.asset(
                "assets/image/clave.jpg",
              ),),
            IconButton(iconSize: 100,onPressed:()=> sendMessage("default","Drum"),
              icon: Image.asset(
                "assets/image/drum.jpeg",
              ),),
            IconButton(iconSize: 100,onPressed:()=> sendMessage("default","Khanjari"),
              icon: Image.asset(
                "assets/image/khanjari.jpg",
              ),),
